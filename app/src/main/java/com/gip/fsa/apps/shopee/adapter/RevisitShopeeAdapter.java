...
public class RevisitShopeeAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RevisitShopeeAdapter(ShopeeModel _shopeeModel) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_TYPE_ITEM) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.shopee_revisit_item, parent, false);
    ...
    private class ItemViewHolder extends RecyclerView.ViewHolder {
        ...
        public ItemViewHolder(@NonNull View view) {
            ...
            linLayout   = view.findViewById(R.id.shopee_revisit_item_layout);
            tvCategory  = view.findViewById(R.id.shopee_revisit_item_category);
            tvCustomer  = view.findViewById(R.id.shopee_revisit_item_customer);
            tvCity      = view.findViewById(R.id.shopee_revisit_item_city);
            tvBank      = view.findViewById(R.id.shopee_revisit_item_bank);
            tvAddress   = view.findViewById(R.id.shopee_revisit_item_address);
            tvTid       = view.findViewById(R.id.shopee_revisit_item_tid);
            tvMid       = view.findViewById(R.id.shopee_revisit_item_mid);
            tvNote      = view.findViewById(R.id.shopee_revisit_item_note);
        }
    }
